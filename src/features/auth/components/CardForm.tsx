...
const inputClass =
  'w-full h-10 border border-gray-200 rounded-lg px-3 text-sm text-gray-900 placeholder:text-gray-400 bg-white focus:outline-none focus:ring-1 focus:ring-gray-900 focus:border-gray-900 transition-shadow';
    ...
    <div>
      {isLoading && (
        <div className="flex items-center justify-center py-8">
          ...
          <span className="ml-2 text-sm text-gray-500">Cargando formulario...</span>
        </div>
      )}
      ...
      >
        {/* Card number */}
        <div>
          <label className="block text-xs font-medium text-gray-500 mb-1">Numero de tarjeta</label>
          <div
            id="mp-card-number"
            className="h-10 border border-gray-200 rounded-lg px-3 bg-white [&_iframe]:!h-full"
          />
        </div>
        ...
        <div className="grid grid-cols-5 gap-3">
          ...
          <div className="col-span-2">
            <label htmlFor="cardholderName" className="block text-xs font-medium text-gray-500 mb-1">
              Titular
            </label>
            <input
              type="text"
        ...
        {!compact && (
          <>
            <div>
              <label htmlFor="cardholderEmail" className="block text-xs font-medium text-gray-500 mb-1">
                Email
              </label>
              <input
                type="email"
            ...
            <div className="grid grid-cols-5 gap-3">
              <div className="col-span-2">
                <label htmlFor="identificationType" className="block text-xs font-medium text-gray-500 mb-1">
                  Tipo doc.
                </label>
                <select
              ...
              <div className="col-span-3">
                <label htmlFor="identificationNumber" className="block text-xs font-medium text-gray-500 mb-1">
                  Numero de documento
                </label>
                <input
                  type="text"

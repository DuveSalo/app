              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <div className="bg-white p-2 rounded border border-gray-200 text-gray-700 break-words">
                      {formatAuditValue(change.oldValue)}
                    </div>
                  </div>
                  <div>
                    <span className="text-gray-500 block mb-1">Ahora:</span>
                    <div className="bg-white p-2 rounded border border-green-200 text-gray-700 break-words">

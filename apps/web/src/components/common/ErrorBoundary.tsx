      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-background px-4">
          <div className="max-w-md w-full bg-background rounded-lg border border-border p-6 text-center">
            ...
            <h1 className="text-base font-semibold text-foreground mb-1">Algo salió mal</h1>
            <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
              Lo sentimos, ocurrió un error inesperado. Por favor intenta recargar la página.
            </p>
            {error && process.env.NODE_ENV !== 'production' && (
              <details className="text-left mb-5 p-3 rounded-lg bg-muted border border-border">

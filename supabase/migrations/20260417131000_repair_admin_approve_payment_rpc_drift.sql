-- ============================================================================
-- Repair admin_approve_payment RPC drift on the linked Supabase project.
-- ----------------------------------------------------------------------------
-- The remote 20260407000001 migration history contains an older function body
-- that overwrote the 20260325110000 date-cast fix. Because applied migrations
-- are immutable, this forward migration restores the current approval flow and
-- makes period values DATE-typed inside the function so the database cannot
-- assign TEXT to DATE columns again.
-- ============================================================================
...
BEGIN
  ...
  -- Get payment details and lock the row so approval remains atomic.

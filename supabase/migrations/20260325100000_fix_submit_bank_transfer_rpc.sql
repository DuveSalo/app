-- Fix submit_bank_transfer_payment RPC:
-- 1. Guard against duplicate pending submissions
-- 2. Clean stale bank_transfer subscriptions before inserting a new approval_pending row
